...
namespace assignment.Pages.Repository
{
    public class ArticleRepository
    {
        public static List<Article> articles = new List<Article>() {
                new Article(){PublishTime=new DateTime(2020,8,20,8,7,20),
                      Id=1,
                      Title ="1-VS中的第一个页面",
                ...
                new Article(){PublishTime=new DateTime(2020,8,21,5,4,20),
                      Id=2,
                ...
                new Article(){PublishTime=new DateTime(2020,8,5,15,20,15),
                      Id=3,
                ...
                new Article(){PublishTime=new DateTime(2020,7,21,11,52,3),
                      Id=4,
                ...
                new Article(){PublishTime=new DateTime(2020,1,2,1,5,2),
                      Id=5,
                ...
                new Article(){PublishTime=new DateTime(2020,9,1,1,5,33),
                      Id=6,
                ...
                new Article(){PublishTime=new DateTime(2020,9,9,3,52,20),
                      Id=7,
                ...
                new Article(){PublishTime=new DateTime(2020,7,1,23,30,30),
                      Id=8,
                ...
                new Article(){PublishTime=new DateTime(2020,11,21,6,22,38),
                      Id=9,
        ...
        public List<Article> Get(int pageIndex,int pageSize)
        {
